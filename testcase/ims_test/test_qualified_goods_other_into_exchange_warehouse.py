...
class TestQualifiedGoodsOtherIntoExchangeWarehouse(object):
    ...
    def test_15_up_shelf_multiple_goods_one_set_to_several_location_by_times(self):
        """
        ...
        for (ware_sku, qty), sj_location_id in zip(ware_sku_qty_list, sj_location_ids):
            ...
            res = ims.qualified_goods_other_in(temp_ware_sku_qty_list, tem_sj_location_id_list,
                                               self.warehouse_id,
