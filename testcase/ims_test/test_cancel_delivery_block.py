...
class TestCancelDeliveryBlock(object):
    def setup_class(self):
        ...
        self.sj_kw_ids = wms_logics.base_get_kw(1, 5, len(self.sale_sku), self.warehouse_id, self.to_warehouse_id)
        self.yk_kw_id = wms_logics.base_get_kw(1, 4, 1, self.warehouse_id, self.to_warehouse_id)
