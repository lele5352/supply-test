...
class TestFHCOtherIntoLP(object):
    ...
    def test_1_up_shelf_one_single_goods_to_one_location(self):
        ...
        res = ims_request.lp_other_in(ware_sku_qty_list, sj_kw_ids, self.warehouse_id, self.to_warehouse_id)
        assert res['code'] == 200
        ...
        for sale_sku in sale_skus:
            ...
            expect_lp_inventory = ims_logics.get_lp_other_in_expect_inventory(ware_sku_qty_list, sj_kw_ids).get(
                sale_sku)
    ...
    def test_3_up_shelf_many_single_goods_to_several_locations(self):
        ...
        sale_skus = ['16338527895']
        ware_sku_qty_list = [('16338527895A01', 2), ('16338527895A01', 3)]
        sj_kw_ids = wms_request.db_get_kw(1, 5, len(ware_sku_qty_list), self.warehouse_id, self.to_warehouse_id)
