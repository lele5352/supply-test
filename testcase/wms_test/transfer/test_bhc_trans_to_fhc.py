...
class TestBHCTransToFHC:
    ...
    def test_1_trans_multiple_goods_components_break_up_suite(self):
        ...
        expect_trans_out_inventory = ims_logics.query_lp_inventory(sale_sku, self.trans_out_id,
                                                                   self.trans_out_to_id)
        expect_trans_in_inventory = ims_logics.query_lp_inventory(sale_sku, self.trans_in_id,
                                                                  self.trans_in_to_id)
