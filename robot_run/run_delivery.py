...
class RunDelivery:
    ...
    def run_front_label_delivery(self, delivery_order_info, delivery_order_detail, flow_flag=None):
        ...
        until(99, 0.5)(lambda: self.wms_app.dbo.query_delivery_order_package_info(delivery_order_code) is not None)()
        ...
        if flow_flag == "call_label":
            return "Success", None
        # 创建拣货单
        create_pick_order_result = self.wms_app.delivery_create_pick_order(delivery_order_code)
    ...
    def run_delivery(self, delivery_order_code, warehouse_id, flow_flag=None):
        ...
        if not self.wms_app.is_success(delivery_order_page_result) or self.wms_app.is_data_empty(delivery_order_page_result):
...
#     delivery_order_code = "PRE-CK2308230019"
#     warehouse_id = 532
#     flag = DeliveryFlow.call_label
#     result, info = RunDelivery().run_delivery(delivery_order_code, warehouse_id, flag)
