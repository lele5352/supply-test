...
def run_receive(distribute_order_code, warehouse_id, to_warehouse_id):
    ...
    if not search_result['code']:
        return 'Fail', "Fail to get entry order page info!"
    ...
    if not scan_result['code']:
        return 'Fail', "Fail to get entry order detail!"
    ...
    if not get_sh_kw_result['code']:
        return 'Fail', "Fail to get receipt warehouse location!"
    ...
    if not get_sj_kw_result['code']:
        return 'Fail', "Fail to get up shelf warehouse location!"
    ...
    if not receive_result['code']:
        return 'Fail', "Fail to confirm receiving!"
