...
class SCMRobot(AppRobot):
    ...
    def get_sku_info(self, sale_sku_code):
        ...
        res = self.call_api(**scm_api_config['get_product_info'])
    ...
    def get_stock_plan_purchase_demand_id(self, stock_plan_no):
        ...
        res = self.call_api(**scm_api_config['get_purchase_demand_page'])
        if not res:
            return
    ...
    def get_purchase_demand_detail(self, purchase_demand_id):
        ...
        res = self.call_api(**scm_api_config['get_purchase_demand_detail'])
    ...
    def batch_get_purchase_demand_detail(self, purchase_demand_id_list):
        ...
        res = self.call_api(**scm_api_config['batch_get_purchase_demand_detail'])
        return res['data'] if res else None
    ...
    def confirm_and_generate_purchase_order(self, purchase_demand_id_list):
        ...
        res = self.call_api(**scm_api_config['confirm_and_generate_purchase_order'])
    ...
    def get_purchase_order_page(self, stock_plan_no):
        ...
        res = self.call_api(**scm_api_config['get_purchase_order_page'])
    ...
    def update_and_submit_purchase_order_to_audit(self, purchase_order_detail):
        ...
        res = self.call_api(**scm_api_config['purchase_order_update'])
        if not res or res['code'] != 200:
            return
        return True
    ...
    def purchase_order_audit(self, purchase_order_id_list):
        ...
        audit_res = self.call_api(**scm_api_config['purchase_order_batch_audit'])
        if not audit_res or audit_res['code'] != 200:
            return
        return True
    ...
    def purchase_order_batch_buy(self, purchase_order_id_list):
        ...
        audit_res = self.call_api(**scm_api_config['purchase_order_batch_buy'])
        if not audit_res or audit_res['code'] != 200:
            return
        return True
    ...
    def get_purchase_order_delivery_detail(self, purchase_order_id):
        ...
        res = self.call_api(**scm_api_config['get_purchase_order_delivery_detail'])
        return res['data']['list'] if res else None
    ...
    def generate_distribute_order(self, purchase_order_delivery_detail, delivery_warehouse_code):
        ...
        res = self.call_api(**scm_api_config['generate_distribute_order'])
        return res['data'] if res else None
    ...
    def purchase_order_delivery(self, distribute_order_info):
        ...
        res = self.call_api(**scm_api_config['purchase_order_delivery'])
        if not res or res['code'] != 200:
            return
        return True
    ...
    def get_distribute_order_page(self, purchase_order_nos):
        ...
        res = self.call_api(**scm_api_config['get_distribute_order_page'])
        if not res:
            return
