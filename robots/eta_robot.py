...
class ETARobot(ServiceRobot):
    ...
    def mall_get_available_stock(self, ck_code_list):
        ...
        res = self.call_api(**eta_api_config['mall_get_available_stock'])
        return res
    ...
    def mall_get_not_trade_self_goods_eta(self, country_code, site_code, sku_codes, zip_code):
        ...
        res = self.call_api(**eta_api_config['mall_get_not_trade_self_goods_eta'])
        return res

    def mall_get_all_country_warehouses(self):
        """获取全部国家发货仓（商城用）"""
        res = self.call_api(**eta_api_config['mall_country_delivery_warehouses'])
        return res
    ...
    def mall_get_trade_self_goods_eta(self, country_code, sku_infos, zip_code):
        ...
        res = self.call_api(**eta_api_config['mall_get_trade_self_goods_eta'])
        return res
    ...
    def mall_get_all_warehouses(self, country_code):
        ...
        res = self.call_api(**eta_api_config['mall_get_country_list'])
        return res
    ...
    def mall_get_inventory(self, abroad_flag, country_code):
        ...
        res = self.call_api(**eta_api_config['mall_get_inventory'])
        return res
    ...
    def mall_get_distribute_warehouses_info_by_country_and_zipcode(self, country_code, abroad_flag):
        ...
        res = self.call_api(**eta_api_config['mall_get_distribute_warehouses_info_by_country_and_zipcode'])
        return res
    ...
    def mall_get_distribute_warehouses_info_by_four_params(self, inputs):
        ...
        res = self.call_api(**eta_api_config['mall_get_distribute_warehouses_info_by_four_params'])
        return res
...
if __name__ == '__main__':
    ...
    zip_code = '1234'
    print(eta_robot.mall_get_not_trade_self_goods_eta(country_code, site, sku_code_list, zip_code))
